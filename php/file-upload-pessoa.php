<?php 
	...
	$listaDocTipo = explode(",",$_POST['out']);//Identifica se o documento é CPF, RG ou outro
	for($i = 0; $i < $arquivos; $i++){
		...
		// O arquivo passou em todas as verificações, hora de tentar movê-lo para a pasta
			...
			criarFilePessoa($_SESSION['idDadosPessoais'], $nome_final, $nome_a_inserir, $tipoDocumento, $listaDocTipo[$i], 0);
			...
			$infoImagenesSubidas[$i]=array("caption"=>$nomeFinal,"downloadUrl"=>$nome_a_inserir,"key"=>$nome_final, "type"=>$type, "tipagem"=>$listaDocTipo[$i]);
